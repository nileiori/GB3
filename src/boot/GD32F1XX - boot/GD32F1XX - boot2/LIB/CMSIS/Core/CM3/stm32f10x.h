...
//  #define HSE_Value    ((uint32_t)25000000) /*!< Value of the External oscillator in Hz */
		#define HSE_Value    ((uint32_t)12000000)//dxl,2015.8,
 #else 
 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
   Timeout value 
   */
//#define HSEStartUp_TimeOut   ((uint16_t)0x0500) /*!< Time out for HSE start up */ dxl,2015.8.7
#define HSEStartUp_TimeOut   ((uint16_t)0xffff)//dxl,2015.8
